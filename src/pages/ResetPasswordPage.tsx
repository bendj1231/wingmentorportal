    ...
    useEffect(() => {
        const initializePage = async () => {
            ...
            const timeoutId = setTimeout(() => {
                if (!isInitialized) {
                    console.error('❌ Initialization timeout - forcing error state');
                    setError('Password reset setup is taking too long. The reset link may be expired or invalid. Please request a new password reset.');
